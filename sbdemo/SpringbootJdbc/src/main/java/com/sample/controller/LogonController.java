	 ...
	 public String createMovie(@RequestBody Movie movie) {
	     try {
			...
			// Establish a database connection (similar to your existing code)
	         ...
	         String INSERT_SQL = "INSERT INTO movie (movie_name, date_time, desc, movie_id, movie_price) VALUES (?, ?, ?, ?, ?)";

	         // Prepare the SQL statement with values from the Movie object
	         PreparedStatement preparedStatement = con.prepareStatement(INSERT_SQL);
	         preparedStatement.setString(1, movie.getMovie_name());
	         preparedStatement.setString(2, movie.getDate_time());
	         preparedStatement.setString(3, movie.getDesc());
	         preparedStatement.setString(4, movie.getMovie_id());
	         preparedStatement.setString(5, movie.getMovie_price());
